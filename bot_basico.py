...
@tree.command(name="painel_basico")
async def painel(it):
    e=Embed(title=f"👑 MONARCH BASICO",description="Sistema completo ativado",color=0xFF8C00)
