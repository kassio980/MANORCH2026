...
@tree.command(name="painel_premium")
async def painel(it):
    e=Embed(title=f"👑 MONARCH PREMIUM",description="Sistema completo ativado",color=0xFF8C00)
